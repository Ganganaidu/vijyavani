...
public class ItemModel4 {
	...
	public ItemModel4(String category, int isactive, String description, int id,
			String name, String price, int main_cat_id, int sub_cat_id, int user_id, String image, 
			String image_link, int sub_item_id)
	{
		...
		this.item_sub_item_id = sub_item_id;
