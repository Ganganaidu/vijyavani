...
public class BalloonOverlayView<Item extends OverlayItem> extends FrameLayout {
	...
	static BalloonOverlayView balloonOverlayView;
	String TAG = "BalloonOverlayView";
	...
	public BalloonOverlayView(final Context context, int balloonBottomOffset) {
		...
		balloonOverlayView = this;
		//Log.d(TAG, "##############Inside of BalloonOverlayView()#############" + balloonBottomOffset);
		setPadding(5, 0, 10, balloonBottomOffset + 15);
